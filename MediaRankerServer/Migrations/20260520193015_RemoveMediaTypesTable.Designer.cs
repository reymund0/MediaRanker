...
namespace MediaRankerServer.Migrations
{
    ...
    [Migration("20260520193015_RemoveMediaTypesTable")]
    partial class RemoveMediaTypesTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MediaRankerServer.Modules.Media.Data.Entities.ImdbImportRating", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_imdb_import_ratings");

                    b.HasIndex("Tconst")
                        .IsUnique()
                        .HasDatabaseName("uq_imdb_import_ratings_tconst");

                    b.ToTable("imdb_import_ratings", (string)null);
                });
