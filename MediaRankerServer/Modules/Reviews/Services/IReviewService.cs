...
{
  Task<List<ReviewDto>> GetReviewsByMediaTypeAsync(string userId, string mediaType, CancellationToken cancellationToken = default);
  Task<PageResult<UnreviewedMediaDto>> GetUnreviewedMediaByTypeAsync(string userId, string mediaType, PageRequest request, CancellationToken cancellationToken = default);
